...
// Code for check BinaryTree is BST or Not start
...
// Code for BinaryTree is BST or Not end
// Code for root to node path in Binary Tree start
...
// Code for root to node path in Binary Tree end
...
int main()
{
	...
	// cout << "Print 0 or 1"
	// 	 << " " << isBST(root) << endl;
	// cout << "Print 0 or 1 in another method"
	// 	 << " " << isBST3(root) << endl;
	// delete root;
